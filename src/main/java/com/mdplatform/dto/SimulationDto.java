...
public class SimulationDto {
    ...
    public static SimulationDto fromEntity(com.mdplatform.model.SimulationJob entity) {
    ...
    public static SimulationDto fromEntityWithDescription(com.mdplatform.model.SimulationJob entity, String taskDescription) {
