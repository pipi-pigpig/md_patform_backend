...
public class SystemCreateRequest {
    ...
    // JSON field getters - convert Object to JSON string
    ...
    public com.mdplatform.model.ElectrolyteSystem toEntity() {
        com.mdplatform.model.ElectrolyteSystem entity = new com.mdplatform.model.ElectrolyteSystem();
