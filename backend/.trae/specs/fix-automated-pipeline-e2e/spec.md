...
* [x] Task 4: 创建PipelineE2ETest
  ...
  * [x] SubTask 4.1: 创建测试类，使用@SpringBootTest(webEnvironment = RANDOM\_PORT) + @ActiveProfiles("test")，注入TestRestTemplate、SimulationJobRepository、CalculationResultRepository
