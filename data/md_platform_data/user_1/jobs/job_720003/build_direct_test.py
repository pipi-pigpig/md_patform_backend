#!/usr/bin/env python3
"""Build direct input with working settings + improper_coeff only"""
import os
...
output_file = os.path.join(workdir, "in.min_direct_test")

# Read the full settings
with open(settings_file, "r") as f:
    all_lines = f.readlines()

# Only remove the comment line 31 (0-indexed: 30), keep improper_coeff
working_lines = []
